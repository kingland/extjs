...
DatePicker = Ext.extend(BoxComponent, {
    ...
    onEnable: function(initial){
        DatePicker.superclass.onEnable.call(this);
    ...
    onDisable : function(){
        DatePicker.superclass.onDisable.call(this);
    ...
    onRender : function(container, position){
        ...
        this.prevRepeater = new ClickRepeater(this.el.child('td.x-date-left a'), {
        ...
        this.nextRepeater = new ClickRepeater(this.el.child('td.x-date-right a'), {
        ...
        this.keyNav = new KeyNav(this.eventEl, {
            'left' : function(e){
                if(e.ctrlKey){
                    this.showPrevMonth();
                }else{
        ...
        if(this.showToday){
            this.todayKeyListener = this.eventEl.addKeyListener(EventObject.SPACE, this.selectToday,  this);
            var today = (new Date()).dateFormat(this.format);
            this.todayBtn = new Button({
