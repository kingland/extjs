...
var RemotingProvider = Ext.extend(JsonProvider, {       
    ...
    constructor : function(config){
        RemotingProvider.superclass.constructor.call(this, config);
        this.addEvents(
    ...
    queueTransaction: function(t){
        ...
        if(this.enableBuffer){
            if(!this.callTask){
                this.callTask = new DelayedTask(this.combineAndSend, this);
            }
...
export default RemotingProvider;
