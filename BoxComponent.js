...
var BoxComponent = Ext.extend(Component, {
    initComponent : function(){
        BoxComponent.superclass.initComponent.call(this);
        this.addEvents(
    ...
    afterRender : function(){
		BoxComponent.superclass.afterRender.call(this);
        if(this.resizeEl){
