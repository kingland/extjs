...
var HtmlEditor = Ext.extend(Field, {
    ...
    createToolbar : function(editor){
        var items = [];
        var tipsEnabled = QuickTips && QuickTips.isEnabled();
        ...
        if(this.enableFont && !Ext.isSafari2){
            var fontSelectItem = new Toolbar.Item({
               autoEl: {
                    tag:'select',
                    cls:'x-font-select',
    ...
    onDisable: function(){
        this.wrap.mask();
        HtmlEditor.superclass.onDisable.call(this);
    },

    onEnable: function(){
        this.wrap.unmask();
        HtmlEditor.superclass.onEnable.call(this);
    },

    setReadOnly: function(readOnly){

        HtmlEditor.superclass.setReadOnly.call(this, readOnly);
        if(this.initialized){
            if(Ext.isIE){
    ...
    createIFrame: function(){
        ...
        this.monitorTask = TaskMgr.start({
    ...
    onResize : function(w, h){
        HtmlEditor.superclass.onResize.apply(this, arguments);
    ...
    setValue : function(v){
        HtmlEditor.superclass.setValue.call(this, v);
        this.pushValue();
        return this;
    },
    ...
    getValue : function() {
        ...
        return HtmlEditor.superclass.getValue.call(this);
    },
    ...
    initEditor : function(){
        ...
        try{
            ...
            DomHelper.applyStyles(dbody, ss);

            doc = this.getDoc();

            if(doc){
                try{
                    EventManager.removeAll(doc);
                }catch(e){}
            }
            ...
            if(Ext.isGecko){
                EventManager.on(doc, 'keypress', this.applyCommand, this);
            }
            if(Ext.isIE || Ext.isWebKit || Ext.isOpera){
                EventManager.on(doc, 'keydown', this.fixKeys, this);
            }
