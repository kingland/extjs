...
var DomQuery = function(){
	...
	jsSelect: function(path, root, type){
	    ...
	    root = root || document;
            ...
            for(var i = 0, len = paths.length; i < len; i++){		
                ...
                if(!cache[subPath]){
                    cache[subPath] = DomQuery.compile(subPath);
                    if(!cache[subPath]){
	...
	isXml: function(el) {
	    ...
	    return DomQuery.jsSelect.call(this, path, root, type);
        ...
        selectValue : function(path, root, defaultValue){
            ...
            if(!valueCache[path]){
                valueCache[path] = DomQuery.compile(path, "select");
            }
        ...
        is : function(el, ss){
            ...
            var isArray = Ext.isArray(el),
            	result = DomQuery.filter(isArray ? el : [el], ss);
